...
;; 5 PTS
(define (find-top G)
  (cond ((eq? (get-vertices G) '()) (topsort-error))
        ((eq? (indegree (get-edges G) (car (get-vertices G))) 0) (car (get-vertices G)))
        (else (find-top (make-graph (cdr (get-vertices G)) (get-edges G))))))
